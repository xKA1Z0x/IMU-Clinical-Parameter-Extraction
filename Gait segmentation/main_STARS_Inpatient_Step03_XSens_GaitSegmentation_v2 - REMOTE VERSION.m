...
specific_part=[""];  %write here specific folder of participants you want this code to process
specific_tasks=[""];  %write here specific folder of tasks or trials you want this code to process

pattern_gait_tasks=["MWT"];%, "TUG", "STAIRS"]; %list of patterns contained in the task names that identify gait patterns (those over which the execution of this code makes sense)
...
plot_verbosity=1; %flag for turning on and off extra plots to check the processing of the code; 1= the code is providing the extra plots, 0=otherwise
